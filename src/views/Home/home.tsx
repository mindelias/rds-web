    ...
    <>
      ...
      <div>
        ...
        <section className="section2">
          ...
          <div className="inner-sect2 row justify-content-center align-items-center">
            <Cards bgColor="lightGreen" className="col-md-3">
            ...
            <Cards bgColor="lightOrange" className="col-md-3">
              <div className="section2-text-cont">
                <P
                  color="darkBlue3"
                  name="Modernize Legacy"
            ...
            <Cards bgColor="lightBlue" className="col-md-3">
              <div className="section2-text-cont">
                <P
                  color="darkBlue3"
                  name="Modernize Legacy"
        ...
        <section className="section3">
          ...
          <div className="row inner-sect3 align-items-center">
            ...
            <div className="col-md-4 desktop">
              <div className="desktop-cont">
                <img className="img1" src={dImg1} alt="desktop1" />
                <img className="img2" src={dImg2} alt="desktop2" />
              </div>
            </div>
